...
import vanilla.expansion.content.VeEntities.Bullet.BulletChain;
import vanilla.expansion.content.VeEntities.Bullet.ChainFragBullet;
import vanilla.expansion.content.VeEntities.Bullet.FragLayer;
import vanilla.expansion.content.VeEntities.Part.StatefulRegionPart;
import vanilla.expansion.content.VeEntities.Part.VePartProgress;
import vanilla.expansion.content.VeType.StatefulWeapon;
...
public class VeUnitTypes {
    ...
    static final Seq<StatusEffect> ARMORCAR_IMMUNITIES = Seq.with(
    ...
    static float HALF_PI = (float) (0.5f * Math.PI);
    ...
    public static void load() {
        ...
        zeta = new UnitType("zeta") {{
            ...
            abilities.add(new RepairFieldAbility(50f, 120f, 64f) {{
                /*
        ...
        eta = new UnitType("eta") {{
            ...
            legContinuousMove = false;
            immunities.add(VeStatusEffects.dusty);
            abilities.add(new RepairFieldAbility(80f, 120f, 80f) {{
                /*
                healEffect = new WaveEffect() {{
                    colorFrom = colorTo = Pal.accent;
                    sizeFrom = 0f; // -
            ...
            weapons.add(
                    ...
                    new StatefulWeapon(VeName("hurricane-gatling")) {{
                        ...
                        StatefulRegionPart hurricaneTube1 = new StatefulRegionPart("-tube") {{
                            speedFunc = PartProgress.heat.min(PartProgress.constant(0.9f)).mul(HALF_PI / 8f / 0.9f);
                            modAmount = HALF_PI;
                        ...
                        parts.add(
                                ...
                                new RegionPart("-tube") {{
                                    mirror = false; // -
                                    heatProgress = PartProgress.warmup;
                                    progress = VePartProgress.sinOf(hurricaneTube1.accumulator.add(HALF_PI));
                                    layerOffset = -0.0015f;
                                    x = 0f;
                                    y = 0f;
                                    moveX = 1.5f;
