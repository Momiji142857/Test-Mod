            ...
            weapons.add(new Weapon() {{
                ...
                bullet = new BasicBulletType(7f, 40f, "circle-bullet") {{
                    ...
                    smokeEffect = new SoundEffect() {{
                        sound = VeSounds.random_lbp3ScifiLaserFire;
                        minPitch = 1f;
                        maxPitch = 1f;
                        minVolume = 0.6f;
                        maxVolume = 0.6f;
...
//            "crawl": CrawlUnit::create;
        ...
        universe = new UnitType("universe") {{
            ...
            lowAltitude = true;
            shadowElevation = 0.2f;
            buildBeamOffset = 10.25f;
            setEnginesMirror(
                    new UnitEngine(31f, -16f, 8f, -90f),
                    new UnitEngine(-31f, -16f, 8f, -90f)
            );
            engineOffset = 20.5f;
            engineSize = 10f;
            ...
            mechFrontSway = 1.5f;
            mechStepParticles = true;
            immunities.addAll(StatusEffects.burning, StatusEffects.electrified,
                    VeStatusEffects.dusty, VeStatusEffects.frozen, VeStatusEffects.interrupted);
            abilities.add(new ShieldRegenFieldAbility(100f, 2000f, 60f, 160f));
            weapons.add(
                    new Weapon(VeName("universe-weapon")) {{
                        mirror = true; // -
                        top = false;
                        shootY = 17f;
                        x = 41f;
                        ...
                        recoil = 0f;
                        recoilTime = 20f;
                        shootSound = VeSounds.random_lbp3ScifiLaserFire;
                        reload = 45f;
                        shootCone = 361f;
                        parts.add(
                                new ShapePart() {{
                        ...
                        BasicBulletType blankProto = new BasicBulletType() {{
                            backColor = frontColor = VePal.white0;
                            lifetime = 8f;
                            speed = 0f;
                            collides = false;
                        ...
                        // BasicBulletType aFrag = (BasicBulletType) blankProto.copy();
                        // BasicBulletType bFrag = (BasicBulletType) blankProto.copy();
                        BasicBulletType lightningC = new BasicBulletType() {{
                            instantDisappear = true;
                            despawnHit = true;
                            fragRandomSpread = 0f;
                            fragSpread = 90f;
                            ...
                            fragOffsetMin = -1.5f;
                            fragOffsetMax = -1.5f;
                            fragBullet = new BasicBulletType(0.1f, 22f, "circle-bullet") {{
                                backColor = Pal.heal;
                                frontColor = Color.white;
                                width = 11f;
                                height = 11f;
                        ...
                        BulletType universeBullet = new PointBulletType() {{
                            trailSpacing = 1f;
                            lifetime = 120f;
                            maxRange = 480f;
                            damage = 300f;
                            ...
                            fragOffsetMin = 0f;
                            fragOffsetMax = 0f;
                            fragBullet = new ExMultiBulletType(
                                    blankProto.copy(),
                                    lightningC
                            );
                            ...
                            hitSound = despawnSound = VeSounds.random_lbp3ScifiLaserFire;
                        }};

                        bullet = ChainFragBullet.create(
                                BulletLayer.nullLayers(4),
                                universeBullet,
                                ChainFragBullet.Mode.APPEND_TO_FRAG_FRAG
                        );
                        bullet.lifetime = 120f;

                        ((ExMultiBulletType) bullet.fragBullet).addBullet(blankProto);
                        BulletType layer1A = ((MultiBulletType) bullet.fragBullet).bullets[0];
                        BulletType layer1B = ((MultiBulletType) bullet.fragBullet).bullets[2];
                        BulletType layer1C = ((MultiBulletType) bullet.fragBullet).bullets[1];
                        BulletType layer2 = BulletChain.get(bullet, 3);
                        ((ExMultiBulletType) layer2.fragBullet).addBullet(blankProto);
                        BulletType layer2A = ((MultiBulletType) layer2.fragBullet).bullets[0];
                        BulletType layer2B = ((MultiBulletType) layer2.fragBullet).bullets[2];
                        // BulletType layer2C = ((MultiBulletType) layer2.fragBullet).bullets[2];
                        BulletType layer3 = BulletChain.get(layer2, 3);
                        BulletType layer4 = BulletChain.get(layer3, 3);
                        BulletType layer4A = ((MultiBulletType) layer4.fragBullet).bullets[0];
                        BulletType layer5 = BulletChain.get(layer4, 3);

                        layer1B.fragBullet = new PointBulletType() {{
                            trailSpacing = 1f;
                            lifetime = 160f;
                            damage = 250f;
                            despawnHit = true;
                            ...
                            fragOffsetMin = 0f;
                            fragOffsetMax = 0f;
                            fragBullet = blankProto.copy();
                            fragBullet.fragBullets = 2;
                            fragBullet.fragBullet = new PointBulletType() {{
                                trailSpacing = 1f;
                                lifetime = 160f;
                                damage = 200f;
                                despawnHit = true;
                        ...
                        layer2B.fragBullet = new PointBulletType() {{
                            trailSpacing = 1f;
                            lifetime = 160f;
                            damage = 250f;
                            despawnHit = true;
                        ...
                        layer1A.fragRandomSpread = 90f;
                        layer1B.fragRandomSpread = 360f;
                        ((BasicBulletType) layer1C.fragBullet).frontColor = Pal.heal;
                        layer2A.fragRandomSpread = 145f;
                        layer2B.fragBullet.damage = 200f;
                        ((ParticleEffect) layer2B.fragBullet.hitEffect).sizeFrom = 4f;
                        layer4A.fragRandomSpread = 270f;
                        layer4A.fragBullets = 2;
                        layer4A.fragBullet.damage = 200f;
                        ((ParticleEffect) layer4A.fragBullet.hitEffect).sizeFrom = 4f;
                        layer5.fragBullet = null;
