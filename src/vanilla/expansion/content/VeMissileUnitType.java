...
public class VeMissileUnitType {

    public static MissileUnitType
            // hovership
            chargeMissile, hurricaneMissile, meteorologyOrb,
    ...
    public static void load() {
        ...
        chargeMissile = new MissileUnitType("charge-missile") {{
...
//            logicControllable = false; // -
            ...
            engineOffset = 5f; // -
            engineSize = 1.8f;
            engineLayer = Layer.bullet;
            engineColor = trailColor = lightColor = Pal.redLight;
            trailLength = 20;
            ...
            immunities.addAll(
                    StatusEffects.burning, StatusEffects.melting, StatusEffects.sapped,
                    StatusEffects.electrified, StatusEffects.disarmed,
                    VeStatusEffects.blown, VeStatusEffects.fusing, VeStatusEffects.combusting
            );
            weapons.add(new Weapon() {{
                ...
                reload = 1f;
                shootCone = 360f;
                bullet = new ExplosionBulletType(58f, 48f) {{
                    lifetime = 12f;
                    damage = 32f;
                    ...
                    smokeEffect = Fx.massiveExplosion;
                    hitShake = 4f;
                    despawnShake = 4f;
                    lightRadius = 48f;
        ...
        hurricaneMissile= new MissileUnitType("hurricane-missile") {{
            ...
            engineOffset = 7f;
            engineSize = 2.25f;
            engineColor = trailColor = lightColor = VePal.skyBlue;
            trailLength = 15;
            deathSound = VeSounds.get("cannonClassic");
            ...
            immunities.addAll(
                    StatusEffects.unmoving, StatusEffects.slow, StatusEffects.fast,
                    StatusEffects.disarmed, StatusEffects.electrified, StatusEffects.invincible,
                    VeStatusEffects.blown
            );
            weapons.add(new Weapon() {{
                mirror = false;
                shootOnDeath = true;
        ...
        meteorologyOrb = new MissileUnitType("meteorology-orb") {{
            constructor = TimedKillUnit::create;
            health = 2000f;
            maxRange = 0f;
            hitSize = 8f;
            ...
            lifetime = 60f * 3f;
            missileAccelTime = 0f; // -
            immunities.addAll(StatusEffects.burning, StatusEffects.freezing, StatusEffects.wet, StatusEffects.muddy,
                    StatusEffects.melting, StatusEffects.sapped, StatusEffects.tarred, StatusEffects.shocked,
                    StatusEffects.corroded, StatusEffects.disarmed, StatusEffects.electrified,
                    VeStatusEffects.blown
            );
            abilities.add(
                    new EnergyFieldAbility(24f, 5f, 108f) {{
                        healEffect = Fx.none;
            ...
            weapons.add(
                    new Weapon() {{
                        ...
                        shootOnDeath = true;
                        shake = 6f;
                        shootSound = Sounds.explosionArtilleryShock;
                        controllable = false;
                        aiControllable = false;
                        autoTarget = false; // -
                        reload = 1f;
                        shootCone = 360f;
                        bullet = new ExplosionBulletType(50f, 96f) {{
                            lifetime = 45f;
                            damage = 5f;
                            knockback = 8f;
                            status = VeStatusEffects.blown;
                    ...
                    new Weapon() {{
                        ...
                        bullet = new LightningBulletType() {{
                            ...
                            statusDuration = 10f;
                            lightningColor = hitColor = lightColor = VePal.skyBlue;
                            lightningLength = 10;
        ...
        alleviateMissile = new MissileUnitType("alleviate-missile") {{
            constructor = TimedKillUnit::create;
            health = 40f;
            armor = 4f;
            maxRange = 6f;
            ...
            engineColor = VePal.skyBlue;
            trailLength = 7; // -
            trailColor = VePal.skyBlue;
            lightColor = VePal.skyBlue;
            deathExplosionEffect = Fx.none;
            lifetime = 65f;
            missileAccelTime = 0f; // -
            immunities.add(VeStatusEffects.blown);
            ...
            weapons.add(new Weapon() {{
                ...
                reload = 1f;
                shootCone = 360f;
                bullet = new ExplosionBulletType(10f, 48f) {{
                    lifetime = 12f;
                    damage = 15f;
